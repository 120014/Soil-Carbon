...
for(i in c(3,5)){#ssp为3:5
  ...
  if(baseline == "sspChange"){
    ...
    TsNPPnm = c(baseline,"TsChang","OaChang","TsOaChangDes0","TsEqnoOaChang", "TsOaChang")[3] #跑前4个就行 # , "ExuChang","OaExuChang"
  }
...
#  sites = seq(1,7905,interval) #抽样选一部分点
  ...
  sink(file.path(Rgl,"outTXT",paste0(outfnm,chagnm,"_",TsNPPnm,sitenml,"_fexu_oa-",fexu_oa,"_",fexudmod,"_output.txt")))
  cat("outfnm=",outfnm,"interval=",interval,"outflux=",outflux,"clab=",clab,"\n")
